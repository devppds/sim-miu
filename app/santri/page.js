    ...
    return (
        <div className="view-container animate-in">
            <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    <h1 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--primary)' }}>Data Santri</h1>
                    <p style={{ color: 'var(--text-muted)' }}>Manajemen data santri Madrasah Ihya' Ulumuddin</p>
                </div>
                <button className="btn btn-primary">
                    <i className="fas fa-plus" style={{ marginRight: '8px' }}></i> Tambah Santri
                </button>
            </div>
